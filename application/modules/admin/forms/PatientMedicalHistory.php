...
class Admin_Form_PatientMedicalHistory extends Zend_Form {
    ...
    public function init() {
       ...
       //echo '<pre>'; print_r($patient_history->dateOfVisit);die;
	   $visit=explode('-',$patient_history->dateOfVisit);
	   $dob=explode('-',$patient_history->dob);
        ...
        $this->addElement('select', 'year_dob', array(
		  ...
		  $this->addElement('select', 'month_visit', array(
            'label' => '',
            'class' => 'inputbox',
            'style'=>'width:100px',
            'TABINDEX' => '6',
        ...
        $this->addElement('select', 'date_visit', array(
            'label' => '',
            'class' => 'inputbox',
            'TABINDEX' => '7',
			'value'=>$visit[2],
        ...
        $this->addElement('select', 'year_visit', array(
            'label' => '',
            'class' => 'inputbox',
            'TABINDEX' => '8',
			'value'=>$visit[0],
